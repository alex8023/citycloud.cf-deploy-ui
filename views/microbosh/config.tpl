  		...
  		<div class="panel-body">
			<form class="form-horizontal" method="post" action="microbosh" enctype="multipart/form-data">
				...
				{{with .NetWork}}
			  	...
			  	<div class="form-group">
			    	<label for="net_id" class="col-sm-3 control-label">NetId</label>
			    	<div class="col-sm-7">
				...
				{{with .Resources}}
			  	<div class="form-group">
			    	<label for="persistent_disk" class="col-sm-3 control-label">PersistentDiskSize</label>
				    <div class="col-sm-7">
			  	...
			  	<div class="form-group">
			    	<label for="instance_type" class="col-sm-3 control-label">InstanceType</label>
			    	<div class="col-sm-7">
			      		<input type="text" class="form-control" id="instance_type" placeholder="InstanceType" name="instance_type" value = "{{.InstanceType}}" required>
			    	</div>
			  	</div>
			  	<div class="form-group">
			    	<label for="availability_zone" class="col-sm-3 control-label">AvailabilityZone</label>
			    	<div class="col-sm-7">
				...
				{{with .CloudProperties}}
			  	<div class="form-group">
			    	<label for="auth_url" class="col-sm-3 control-label">AuthUrl</label>
			    	<div class="col-sm-7">
				...
				<div class="form-group">
					...
					{{if ne $.IaaSVersion $.DefaultVersion}}
					  	<div class="form-group">
						    	<label for="cci_ebs_url" class="col-sm-3 control-label">NBSAuthUrl1</label>
						    	<div class="col-sm-7">
					  	...
					  	<div class="form-group">
						    	<label for="cci_ebs_accesskey" class="col-sm-3 control-label">NBSAccesskey</label>
						    	<div class="col-sm-7">
					  	...
					  	<div class="form-group">
						    	<label for="cci_ebs_secretkey" class="col-sm-3 control-label">NBSSecretkey</label>
						    	<div class="col-sm-7">
