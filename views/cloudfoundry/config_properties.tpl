		...
		<div class="panel-heading" >
  		...
  		<div class="panel-body">
			<form class="form-horizontal" method="post" action="cloudfoundry">
				...
				{{else}}
			  	<div class="form-group">
			    	<label for="floatingIp" class="col-sm-3 control-label">{{i18n $.Lang "FloatingIp"}}</label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="floatingIp" placeholder="{{i18n $.Lang "FloatingIp"}}" name="floatingIp" value = "{{.FloatingIp}}" required>
				    </div>
			  	</div>
				{{end}}
			  	<div class="form-group">
