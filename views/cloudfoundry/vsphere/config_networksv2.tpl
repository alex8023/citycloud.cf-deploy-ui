		{{with .CloudFoundry}}
			{{with .NetWorks}}
				{{with .private}}
			  	...
			  	<div class="form-group">
			    	<label for="netId" class="col-sm-3 control-label">VlanName</label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="netId" placeholder="VlanName" name="private-netId" value = "{{.NetId}}" required>
				    </div>
			  	</div>
			  	<div class="form-group">
				...
				<div class="form-group">
			    	<label for="netType" class="col-sm-3 control-label">GateWay</label>
				    <div class="col-sm-7">
				      <input type="text" class="form-control" id="netType" placeholder="GateWay" name="private-netType" value = "{{.NetType}}" required>
				    </div>
			  	</div>
			  	<div class="form-group">
