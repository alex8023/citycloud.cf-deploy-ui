				  		...
				  		<div class="panel-body">
							<div class="form-group">
							    <div class="col-sm-offset-2 col-sm-10">
							      	<button class="btn btn-default " id = "config-Compilation"><span class="glyphicon glyphicon-edit"></span> Config</button>
							    </div>
							...
							<div class="form-group">
								<label class="col-sm-3 control-label">Instance-Flavor</label>
								<div class="col-sm-5">
