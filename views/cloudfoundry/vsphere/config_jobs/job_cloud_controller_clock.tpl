		...
		<div class="form-horizontal">
		  	<div class="panel-body">
			  	<div class="form-group">
			    	<label for="{{.cloud_controller_clock.JobName}}_name" class="col-sm-3 control-label">Name</label>
				    <div class="col-sm-7">
			  	...
			  	<div class="form-group">
			    	<label for="{{.cloud_controller_clock.JobName}}_resourcesPool" class="col-sm-3 control-label">ResourcesPool</label>
				    <div class="col-sm-7">
						...
						{{range $.VsphereResourcesPools}}<option id="{{$cloud_controller_clock}}_{{.Name}}" value="{{.Name}}">{{.Name}}</option>{{end}}
						</select>
			  	...
			  	<div class="form-group">
			    	<label for="{{.cloud_controller_clock.JobName}}_instances" class="col-sm-3 control-label">Instances</label>
				    <div class="col-sm-7">
				      	<input type="number" class="form-control" id="{{.cloud_controller_clock.JobName}}_instances" placeholder="Instances" name="{{.cloud_controller_clock.JobName}}_instances" value = "{{.cloud_controller_clock.Instances}}" required readonly>
				    </div>
			  	</div>
			</div>
		</div>
