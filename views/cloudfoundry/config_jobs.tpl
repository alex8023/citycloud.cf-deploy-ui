  		...
  		<div class="panel-body">
			<form class="form-horizontal" method="post" action="cloudfoundry">
				...
				{{with .CloudFoundry}}
					...
					{{template "cloudfoundry/config_jobs/job_postgres.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_nfs.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_nats.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_syslog_aggregator.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_etcd.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_loggregator.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_loggregator_traffic.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_uaa.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_cloud_controller_ng.tpl" .}}
					{{template "cloudfoundry/config_jobs/job_cloud_controller_worker.tpl" .}}
