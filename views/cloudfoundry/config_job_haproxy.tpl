					...
					<div class="form-horizontal">
					  	<div class="panel-body">
						  	...
						  	<div class="form-group">
							    ...
							    <div class="col-sm-10">
							      	<input type="number" class="form-control" id="{{.dea_next.JobName}}_instances" placeholder="Instances" name="{{.etcd.JobName}}_instances" value = "{{.dea_next.Instances}}" required readonly>
							    </div>
						  	</div>
						</div>
					</div>
