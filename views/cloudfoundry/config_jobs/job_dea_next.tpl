		...
		<div class="form-horizontal">
		  	<div class="panel-body">
			  	<div class="form-group">
				    ...
				    <div class="col-sm-7">
				      	<input type="text" class="form-control" id="{{.dea_next.JobName}}_name" placeholder="{{i18n $.Lang "Name"}}" name="{{.dea_next.JobName}}_name" value = "{{.dea_next.Name}}" required>
				    </div>
			  	</div>
			  	<div class="form-group">
				    ...
				    <div class="col-sm-7">
						...
						{{range $.CloudFoundry.ResourcesPools}}<option id="{{$dea_next}}_{{.Name}}" value="{{.Name}}">{{.Name}}</option>{{end}}
						</select>
