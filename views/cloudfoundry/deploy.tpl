	  		...
	  		<div class="panel-body">
				...
				<div class="btn-group btn-group" role="group">
					...
					<div class="btn-group btn-group" role="group">
						...
						<button class="btn btn-default " id = "deploy-microbosh" data-toggle="tooltip" data-placement="right" title="部署PaaS">Deploy</button>
						<button class="btn btn-default " id = "login-microbosh" data-toggle="tooltip" data-placement="right" title="登录PaaS">Login</button>
					</div>
