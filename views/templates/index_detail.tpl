<div class="container">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="button" class="btn btn-default" data-toggle="modal" data-target="#config-custom-template" data-whatever="add"><span class="glyphicon glyphicon-plus"></span> Add-War</button>
	...
	<div class="panel panel-default">
		<div class="panel-heading" >
			<h2 class="panel-title">Custom Services - <b>{{.Service.Name}}-Compont</b></h2>
		</div>
		<div class="panel-body">
			<div class="col-sm-offset-2 col-sm-10">
				<button type="button" class="btn btn-default" data-toggle="modal" data-target="#config-custom-template" data-whatever="add"><span class="glyphicon glyphicon-plus"></span> Add-Config</button>
			</div>
		    <table class="table table-responsive ">
				<thead>
					<tr>
